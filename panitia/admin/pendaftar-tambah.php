  ...
  <div class="container-fluid">
    ...
    <div class="row mt-5">
      ...
      <div class="col-ml-5 mt-4 text-center">
        <h3>Halaman Tambah Pendaftar Khitan Umum</h3>
      ...
      <div class="row pt-2 justify-content-center">
        <div class="col-md-8">
          <div class="card card-outline card-primary mt-2">
            ...
            <div class="card-body">
              <ul>
                <li>Hanya Admin yang bisa akses form ini</li>
                <li>Menyiapkan Foto / Gambar KK atau KIA untuk diupload</li>
              </ul>
                <button id="btn-daftar" class="btn btn-success mt-3">Daftar</button>
                <button id="btn-kembali" class="btn btn-secondary mt-3" onclick="window.location.href='pendaftar.php';">Kembali</button>
            </div>
          </div>
                ...
                <div class="row mb">
                  <div class="col">
                    ...
                    <div class="row">
                        ...
                        <a href="pendaftar.php" class="btn btn-secondary" onclick="return confirm('Apakah Anda yakin ingin kembali? Data yang belum disimpan akan hilang.')">Kembali</a>
                        </div>
